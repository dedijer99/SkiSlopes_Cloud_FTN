...
namespace AzureTableStorage
{
    ...
    /// </summary>
    internal sealed class AzureTableStorage : StatelessService, ITableStorage
    {
        public const string ConnectionString = "UseDevelopmentStorage=true";

        public AzureTableStorage(StatelessServiceContext context)
            : base(context)
        { }

        public async Task<List<SkiSlopeState>> GetAllSkiSlopeStates()
        {
